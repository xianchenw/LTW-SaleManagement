    ...
    <section class="product">
        <div class="container">
            <div class="row bg-white pt-4 pb-4 border-bt pc">
                <a style="align-self: center;text-decoration:none;color:black;" class="col-md-2" href="/order?status=1"><h3 style="text-align:center">PENDING</h3></a>
                <a style="align-self: center;text-decoration:none;color:black;" class="col-md-2" href="/order?status=2"><h3 style="text-align:center">CONFIRMED</h3></a>
                <a style="align-self: center;text-decoration:none;color:black;" class="col-md-2" href="/order?status=3"><h3 style="text-align:center">SHIPPING</h3></a>
                <a style="align-self: center;text-decoration:none;color:black;" class="col-md-2" href="/order?status=4"><h3 style="text-align:center">DELIVERED</h3></a>
                <a style="align-self: center;text-decoration:none;color:black;" class="col-md-2" href="/order?status=6"><h3 style="text-align:center">COMPLETED</h3></a>
                <a style="align-self: center;text-decoration:none;color:black;" class="col-md-2" href="/order?status=7"><h3 style="text-align:center">CANCELLED</h3></a>
            </div>
            <br><br>
            <div class="row bg-white pt-4 pb-4 border-bt pc">
